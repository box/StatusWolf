...
var swcolors = {
	...
	,YellowGreens: {
		...
		,4: ['#CFF700', '#A3B92E', '#87A000', '#DDEFB3F']
		,5: ['#CFF700', '#A3B92E', '#87A000', '#DDFBB3F', '#E5FB71']
	}
	,Greens: {
		1: ['#62E200']
		,2: ['#62E200', '#62AA2A']
...
swcolors.Wheel[1] = swcolors.Oranges[1].concat(swcolors.Greens[1]
	,swcolors.OrangeYellows[1]
	,swcolors.LtBlues[1]
	,swcolors.Yellows[1]
	,swcolors.Magentas[1]
...
swcolors.Wheel[2] = swcolors.Wheel[1].concat(swcolors.Oranges[2][1]
	,swcolors.Greens[2][1]
...
swcolors.Wheel[3] = swcolors.Wheel[2].concat(swcolors.Oranges[3][2]
	,swcolors.Greens[3][2]
...
swcolors.Wheel[4] = swcolors.Wheel[3].concat(swcolors.Oranges[4][3]
	,swcolors.Greens[4][3]
...
swcolors.Wheel[5] = swcolors.Wheel[4].concat(swcolors.Oranges[5][4]
	,swcolors.Greens[5][4]
