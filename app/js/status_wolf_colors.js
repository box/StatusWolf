...
swcolors.Wheel[1] = swcolors.Greens[1].concat(swcolors.Oranges[1]
	,swcolors.LtBlues[1]
	,swcolors.OrangeYellows[1]
	,swcolors.Magentas[1]
	,swcolors.Yellows[1]
...
swcolors.Wheel[2] = swcolors.Wheel[1].concat(swcolors.Greens[2][1]
...
swcolors.Wheel[3] = swcolors.Wheel[2].concat(swcolors.Greens[3][2]
...
swcolors.Wheel[4] = swcolors.Wheel[3].concat(swcolors.Greens[4][3]
...
swcolors.Wheel[5] = swcolors.Wheel[4].concat(swcolors.Greens[5][4]
